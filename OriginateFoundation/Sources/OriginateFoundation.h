...
//! Project version number for OriginateFoundation.
FOUNDATION_EXPORT double OriginateFoundationVersionNumber;

//! Project version string for OriginateFoundation.
...
#import <OriginateFoundation/NSArray+OFFunctional.h>
